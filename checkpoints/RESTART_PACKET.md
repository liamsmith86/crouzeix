...
## Current general Crabb frontier (2026-07-25): after L269 / A216
...
relative grade-one response, and A203/L257 turns its transport into
  ...
  Prove this shallow-plus-deep-divergence form in all grades; do not
  try to delete the deep words or promote the finite pattern.
...
## Next five concrete actions (refreshed after L269 / A216)
...
2. **Derive L269's shallow-plus-deep-divergence recurrence.**  In L264's port-isolated
   ...
   Derive the radial polynomial moments `P_k(1)=0`,
   `P_k'(1)=−1`.  Do not assume away a copy-dependent insertion, do
   not delete the deep remainder, and perform the split only after
   both contour integrations.
...
Read the newest L258--L269 sections of `RESEARCH_STATE.md`, the
corresponding proof notes, and A194/A204--A216.  The live gate is the
...
trace-zero Stein divergence.  Treat A213's two-sided leakage-ideal
placement and the shallow-plus-deep-divergence split as stop
conditions, not established facts.  L266 proves
...
split every deep term into a delayed trace-zero divergence, and
compute the shallow remainder's bilateral-symbol constant as four using
