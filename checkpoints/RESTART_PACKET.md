...
## Current general Crabb frontier (2026-07-25): after L268 / A215
...
relative grade-one response, and A203/L257 turns its transport into
  ...
  trace-only calculation and close both of its stop conditions.
...
## Next five concrete actions (refreshed after L268 / A215)
...
2. **Close A213's post-contour depth/row filtration.**  In L264's port-isolated
...
Read the newest L258--L268 sections of `RESEARCH_STATE.md`, the
corresponding proof notes, and A194/A204--A215.  The live gate is the
...
one-shot operator congruence.  Treat A213's
