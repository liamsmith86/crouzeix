...
| L9 | Saturation rigidity: W=2 ⟹ P^{1/2}(σ)y = e^{−iψ}f₀(σ)P^{1/2}(σ)x₀ a.e. (y = normalized γ_Φ(f₀)x₀) | UNRESOLVED (derivation sketched, needs write-up) | Route to quantitative W ≤ 2 − φ(c) |
