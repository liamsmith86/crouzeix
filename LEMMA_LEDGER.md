...
| L16 | Even-phase structure: extremal f₀ = ±b_v∘(φ²) with v = α² = pseudo-hyperbolic midpoint of (τ₁²,τ₂²) [stationarity via symmetric+even norm & Möbius flow]; q₁ = q₂ = 1/2 [traceless-involution identity xᵀRx = 0, sympy-verified]; ρ = 1 − Θ explicit | PROVED (2026-07-21) | sym3 mechanism one level up. proof/slice_closed_form.md §4 |
| EL4 | Θ(k,U₂) ≤ 1 on (0,1)×(0,K) (even-phase level-4 elliptic inequality; U₂→0 edge = Landen theorem) | NUMERICAL — **CENTRAL TARGET (Epoch 5)** | 50×50 grid 0 neg (min 2.4e-15); edge ~ c·ε⁴ verified dps 50/80; ⟹ H-r for even-phase elliptic sym4 slice |
