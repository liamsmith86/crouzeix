...
def exact_algebra_audit() -> None:
    ...
    upper = sp.Matrix([[sp.Rational(1, 5), sp.Rational(2, 7)], [sp.Rational(-1, 4), sp.Rational(1, 3)]])
    lower = sp.Matrix([[sp.Rational(2, 9), sp.Rational(-1, 6)], [sp.Rational(3, 8), sp.Rational(1, 7)]])
    zero = sp.zeros(2)
