...
| A22 | F/B | Prove the full polynomial transfer core by projective principal-minor charts | **ACTIVE — LOW MINORS CLOSED, DET0 INTEGRATION OPEN** | L54 covers `c∈[.01,.020736]`, all charts/signs. On `[0,.005]`, det1 and det0's 26-chart local `U` hierarchy now pass for both signs, and exact forms (28)–(33) plus integrated local/global Bernstein covers prove all three final minors for both signs. The det0 global top chart still follows intersecting exact-equality arms (nome-dominant, then main-dominant at normalized `S=1/2`); small negative interval lower bounds are enclosure debt, not counterexamples. Factor and finitely cover those arms, then bridge `.005→.01`. Exact terms remain rational through 15 with Arb tails at 16/17. No negative core has appeared. `proof/slice_core_projective_reduction.md` |
