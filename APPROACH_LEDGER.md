...
| A22 | F/B | Prove the full polynomial transfer core by projective principal-minor charts | **ACTIVE — L51--L55, GLOBAL `c` COVER OPEN** | L54 rigorously covers `c∈[.01,.020736]`, all final charts/signs. L55 normalizes the low core and factors every exposed exceptional face. For det1, two new exact blow-ups end in a positive-definite quadratic; two 59-chart runs certify the full main chart for both signs on `[0,.005]`. The det0 main-orientation remainder and four det0 corner charts close, with one equality axis left. Exact terms remain rational through order 15 with parity-aware Arb tails at 16/17. Next close det0's axis and the low minors, then bridge `.005→.01`. No negative core has appeared. `proof/slice_core_projective_reduction.md` |
