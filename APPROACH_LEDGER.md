...
| A22 | F/B | Prove the full polynomial transfer core by projective principal-minor charts | **ACTIVE — L51--L55, GLOBAL `c` COVER OPEN** | L51--L53 give the exact chart hierarchy and close the orientation faces. L54 now rigorously covers `c∈[.01,.020736]` with four Arb/directed-Bernstein boxes, all final charts and signs. L55 normalizes the low-nome determinant/minors and factors every newly exposed exceptional face into nonnegative forms. The det0 main-orientation remainder closes; four det0 `a=0` corner charts close, with one main-axis equality line left. The det1 orientation endpoints are factorized exactly but still need a finite tail enclosure. Exact Taylor terms stay rational through order 15 and parity-aware Arb tails start at 16/17. Continue those covers while extending the compact boxes. No negative core has appeared. `proof/slice_core_projective_reduction.md` |
