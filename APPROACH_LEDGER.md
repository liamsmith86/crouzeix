...
| A16 | F | Eliminate the contraction LMIs with Stein defects and classify coupled KKT rank faces | ACTIVE — ONE RANK FACE LEFT | L27 parameterizes every contraction metric by two PSD 2×2 defects through a Szegő kernel. Complementary slackness reduces any hypothetical optimum above four to rank-one/rank-one or rank-one/full coupled faces. A17 now closes the generic rank-one/full face; only rank-one/rank-one remains. `proof/slice_coupled_defects.md` |
