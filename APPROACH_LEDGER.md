...
| A22 | F/B | Prove the full polynomial transfer core by projective principal-minor charts | **ACTIVE — L51--L55, GLOBAL `c` COVER OPEN** | L54 covers `c∈[.01,.020736]`, all charts/signs. L55 factors the low core. Two 59-chart runs close det1 for both signs on `[0,.005]`. Det0's former `U`-axis debt now ends in the coefficient-positive forms (26)–(27), and 26 charts certify that local hierarchy for the positive sign on `[0,.005]`. Next rerun det0 negative, integrate the local cover, close the low minors, then bridge `.005→.01`. Exact terms remain rational through 15 with Arb tails at 16/17. No negative core has appeared. `proof/slice_core_projective_reduction.md` |
