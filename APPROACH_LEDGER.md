...
| A17 | F/B | Convert the rank-one/full coupled face to an odd two-node Blaschke block | ACTIVE — TINY-NOME COMPLEMENT LEFT | L28 identifies the rank-one/full face with an odd Blaschke block; the lower block is proved. L30–L32 reduce the upper block to two endpoint residuals. L33 closes `c≥12599/20000`; L36 interval-certifies `c≥1/12`; L34/L35 center the ridge and close its core through `c=1/20`. Only the multiscale complement in `0<c<1/12` remains. `proof/slice_odd_block_reduction.md` |
