...
and for `p=4` by the full elliptic-slice theorem L20.  The next
dimension-independent problem is an exact condition-four certificate
for the conformally pulled-back Chebyshev--Lobatto family
`C_p+cC_p*`, followed by uniform transverse absorption.
