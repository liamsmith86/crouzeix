...
bound on the center by Berger--Okubo--Ando.  L72 proves ambient stationarity on
that curve, and L73 supplies the uniform analytic normal estimate, avoiding an
indefinite sequence of higher orders.
