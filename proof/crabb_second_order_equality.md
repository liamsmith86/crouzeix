...
`proof/p3_crabb_higher_order.md`.  L69 supplies the exact local affine-unitary slice.  Its
weighted coupling to the negative second-order directions remains before this is a
punctured-neighbourhood theorem.  Higher sizes then require the same calculation on the grade
representatives classified above.
