...
All determinant and final minor charts, both signs, certify on the two-box
cover

\[
 [.01,.012]\cup[.012,.0144]=[.01,.0144]. \tag{14}
\]
...
$3,049,4,985,2,215,130,384$ and again $1,3,5,2,4$. Thus (RT) is proved on the
...
shared Bernstein coordinate. At $c=0$, turn L55's three explicit exceptional
forms into a finite remainder enclosure; do not return to the raw singular
records. Success proves (RT) and therefore completes the elliptic $4\times4$
